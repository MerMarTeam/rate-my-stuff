	...
	return (
		<div className="post-rating">
			...
			<i
				...
				className={star1Hovered ? 'bi bi-star-fill fa-2x' : 'bi bi-star fa-2x'}
			...
			<i
				...
				style={starStyle}
				onClick={handleStarClick}
				className={star2Hovered ? 'bi bi-star-fill fa-2x' : 'bi bi-star fa-2x'}
				onMouseEnter={handleStarHover}
				onMouseLeave={handleStarHover}
			></i>
			<i
				...
				style={starStyle}
				onClick={handleStarClick}
				className={star3Hovered ? 'bi bi-star-fill fa-2x' : 'bi bi-star fa-2x'}
				onMouseEnter={handleStarHover}
				onMouseLeave={handleStarHover}
			></i>
			<i
				...
				style={starStyle}
				onClick={handleStarClick}
				className={star4Hovered ? 'bi bi-star-fill fa-2x' : 'bi bi-star fa-2x'}
				onMouseEnter={handleStarHover}
				onMouseLeave={handleStarHover}
			></i>
			<i
				...
				style={starStyle}
				onClick={handleStarClick}
				className={star5Hovered ? 'bi bi-star-fill fa-2x' : 'bi bi-star fa-2x'}
				onMouseEnter={handleStarHover}
				onMouseLeave={handleStarHover}
			></i>
