	...
	function calculateTopFivePosts() {
		...
		if (postsArray.length > 0) {
			postsArray.forEach((post) => {
				...
				postsIdsWithAverages.push({
					id: post.id,
					title: post.title,
					average: average,
				});
			});
			let tempFive = [...postsIdsWithAverages]
		...
		<>
			<div className="parent-div">
				<div className="homepage">
					{[...postsArray].reverse().map((post, i) => {
						return (
							<div key={post.id} className="post">
								...
								<Rating
									post={post}
									postNewRating={postNewRating}
									calculateTopFivePosts={calculateTopFivePosts}
								/>
					...
					<br />
					<Link className="create-post-link" to="/create">
						<button
					...
					<section>
						...
						<ul className="top-five-list">
							{topFive &&
								topFive.map((post, i) => {
									return (
										<li key={post.id} className="top-element">
											<Link to={`/posts/${post.id}`}>
												{i + 1}.{' '}
			...
			<div className="footer-div">
				<footer className="parent-footer">
					...
					<section className="what-is">
						...
						<p>
							Welcome to RMS, your go-to platform for sharing and celebrating
							the things that matter to you! Upload your favorite images and let
							the community weigh in with votes and comments. Whether it's your
							latest DIY project, a stunning travel photo, or anything else
							you're proud of, "Rate My Stuff" is the place to showcase your
							creations and gather feedback from a supportive community. Join us
							in fostering a vibrant space for creativity, inspiration, and
							friendly interactions. Start uploading, voting, and engaging
							today!
						</p>
					</section>
				</footer>
